...
@interface UserLiveViewController ()<AVCaptureVideoDataOutputSampleBufferDelegate,AVCaptureAudioDataOutputSampleBufferDelegate>
@property (nonatomic, strong) AVCaptureSession *captureSession;
@property (nonatomic, strong) AVCaptureDeviceInput *currentVideoDeviceInput;
@property (nonatomic, weak) UIImageView *cursorImageView;
...
- (void)setFocusCursorWithPoint:(CGPoint)point{
    ...
    _cursorImageView.transform = CGAffineTransformMakeScale(1.5, 1.5);
    _cursorImageView.alpha = 1.0;
    [UIView animateWithDuration:1.0 animations:^{
        _cursorImageView.transform = CGAffineTransformIdentity;
    }completion:^(BOOL finished) {
        _cursorImageView.alpha = 0;
    }];
}
